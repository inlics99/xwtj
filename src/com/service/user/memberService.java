...
public interface memberService {
	 ...
	 public int personReg(String username,String password,String type,String realname,String sex,String bir,String sheng,String city,String telphone,String email,String question,String answer,String lastip,int off,String address);//会员注册
	 public List getRegInfo(String username);//某会员资料
	 public int uppersonReg(String username,pmember pmem);//修改会员资料
