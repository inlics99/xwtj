...
<jsp:useBean id="mmb" scope="page" class="com.service.user.impl.userAdministrationServiceImpl" ></jsp:useBean>
...
<TABLE width="100%" border=1 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
   ...
   <tr>
   <td align=center colspan=2 ><a href="javascript:history.back(-1)">返回上一页</a></td>
   </tr>
   </table>
  </body>
</html>
