...
<jsp:useBean id="mb" scope="page" class="com.service.user.impl.userAdministrationServiceImpl" />
<jsp:useBean id="sn" scope="page" class="com.service.admin.impl.systemServiceImpl" /> 
<%
       ...
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<%
		  ...
		  <TR align="center" bgColor=#ffffff>
		    <TD id=map><%=i+1 %></TD>
			<TD id=map>
			<a title="点击查看详细信息" href="<%=basePath%>admin/member/pminfo.jsp?id=<%=pagelist2.get(0).toString()%>"	>					
			<%=pagelist2.get(1).toString() %>
			</a>
			</TD>
			<TD id=map id="<%=pagelist2.get(0).toString()%>"><%=pagelist2.get(0).toString()%></TD>
			...
			<TD id=map><a href="<%=basePath%>MemberManage?method=CLOSE&cid=<%=pagelist2.get(0).toString()%>">
			<%if(Integer.parseInt(pagelist2.get(3).toString())==1){%><font color=blue>在用</font><%}else{%><font color=red>冻结</font><%} %>
			</a></TD>
			<TD id=map><a href="<%=basePath%>MemberManage?method=DELMEMBER&did=<%=pagelist2.get(0).toString()%>">删除</a></TD>
		  </TR>
		<%}%>    
		  </TBODY>
      </TABLE></form>
	     ...
	     <TR>
    	   <TD align="right" vAlign=top >
			 ...
			 <input type="hidden" name="page" value="<%=session.getAttribute("busPage").toString()%>" /><!--//用于给上面javascript传值-->         
							<a href="#" onClick="ap4()"><img src="<%=basePath %>images/first.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
				<a href="#" onClick="ap2()"><img src="<%=basePath %>images/pre.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
				...
				<a href="#" onClick="ap()"><img src="<%=basePath %>images/next.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
				<a href="#" onClick="ap3()"><img src="<%=basePath %>images/last.gif" border="0" /></a>
			 第<input name="busjump" type="text" size="3" />页<a href="#" onClick="ap5()"><img src="<%=basePath %>images/jump.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
			 <button onClick="ap()">点击</button>
			 </form>
             </TD>
             </TR>
			 </TBODY>
